<?php      
	...
	$form_placerating = $_POST['form_placerating'];
		...
		echo "<h2><center><a href='../places-reviews.php'>Check your review again</a><center></h2>";
			...
			echo "<h2><center><a href='../places-reviews.php'>Check your review again</a><center></h2>";
				...
				echo "<h2><center><a href='../places-reviews.php'>Check your review again</a><center></h2>";
						...
						$stmt = $conn->prepare("INSERT INTO places_reviews (nickname, place_name, place_address, place_rating, place_review) VALUES (?, ?, ?, ?, ?)");
						$stmt->bind_param ("sssss", $form_nickname, $form_placename, $form_placeaddress, $form_placerating, $form_placereview);
						...
						if ($stmt->execute()) {
							...
							<h3><center>Rating: <?php echo $form_placerating; ?></center></h3>
